  ...
  return (
    <div className="w-full h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-1 p-4 space-y-4 overflow-y-auto pb-24">
        ...
        <div className={sectionClass}>
          <h2 className="text-sm font-black mb-4 text-brand-primary uppercase tracking-widest border-b pb-1">Marriage & Partner Preferences</h2>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <label className={labelClass}>Relocation</label>
