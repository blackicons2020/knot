            ...
            <div className="space-y-2">
                ...
                <ProfileSection title="Marriage Expectations">
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <ProfileDataItem label="Partner Age" value={user.preferredPartnerAgeRange ? `${user.preferredPartnerAgeRange[0]} - ${user.preferredPartnerAgeRange[1]} years` : 'Not specified'} />
                    </div>
