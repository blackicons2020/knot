        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={(e) => {
                e.stopPropagation();
                onCardClick(match); // For now, let's just open profile, but we could trigger onUpgrade if we had it here
              }}
              className="p-3 bg-gray-100 dark:bg-gray-800 text-brand-primary dark:text-brand-accent rounded-2xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-all active:scale-95"
            >
