...
const ProfileDetailScreen: React.FC<ProfileDetailScreenProps> = ({ match, user, onBack, onStartChat, onUpgrade }) => {
  const [currentPhotoIndex, setCurrentPhotoIndex] = useState(0);

  const isAccessRestricted = !user.isPremium || !match.isPremium;
          ...
          <div className="px-8 space-y-2">
                  ...
                  <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <ProfileDataItem label="City" value={isAccessRestricted ? "••••••" : match.residenceCity} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <ProfileDataItem label="City" value={isAccessRestricted ? "••••••" : match.originCity} />
                            </div>
                            <div className="pt-2">
              ...
              <ProfileSection title="Marriage Expectations">
                  <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                      ...
                      <ProfileDataItem label="Partner Age" value={match.preferredPartnerAgeRange ? `${match.preferredPartnerAgeRange[0]} - ${match.preferredPartnerAgeRange[1]} years` : 'Not specified'} />
                  </div>
