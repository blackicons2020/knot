...
const s = StyleSheet.create({
  ...
  shieldWrap: { backgroundColor: Colors.darkSurface, padding: 32, borderRadius: 40, marginBottom: 24, position: 'relative' },
  ...
  stepBox: { flex: 1, alignItems: 'center', backgroundColor: Colors.darkSurface, padding: 16, borderRadius: BorderRadius.lg, borderWidth: 1, borderColor: Colors.darkBorder },
  ...
  idCard: { flexDirection: 'row', alignItems: 'center', padding: 20, borderRadius: BorderRadius.lg, borderWidth: 1, borderColor: Colors.darkBorder, marginBottom: 12, elevation: 1 },
  ...
  galleryBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, padding: 16, borderRadius: BorderRadius.lg, borderWidth: 1.5, borderStyle: 'dashed', borderColor: Colors.darkBorder },
